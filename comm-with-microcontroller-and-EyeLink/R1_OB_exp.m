...
R1_onsets=[]; %Initialise timing file
trialNumber=0;
...
% ListenChar(2); % prevent spilling of keyboard output to console
...
for i =1: size (array_VBP,1)
    
    
    % Visual button press trials
    ...
    KbQueueFlush(-1); % clear button presses from the fixation period

    
    
    for j=1:size(array_VBP,2)
        
        trialNumber = trialNumber+1;
        Eyelink('Message', sprintf('TRIAL %u', trialNumber));
        
        switch array_VBP(i,j)
            
            case 1
                fprintf('The onset time for VBP-led1 in block %d is %f seconds\n',i, GetSecs-start_time);
                led1.write(1);
                stim_time=GetSecs;
                WaitSecs(0.2);
                led1.write(0);
                ...
                if pressed                     
                    ...
                    R1_onsets=[R1_onsets;NaN 1 stim_onset bp_onset RT];
                else
                    R1_onsets=[R1_onsets;NaN NaN stim_onset NaN NaN];
                end
                continue
                
            case 2
                fprintf('The onset time for VBP-led2 in block %d is %f seconds\n',i, GetSecs-start_time);
                led2.write(1) ;
                stim_time=GetSecs;
                WaitSecs(0.2);
                led2.write(0);
            ...
            case 3
                fprintf('The onset time for VBP-led3 in block %d is %f seconds\n',i, GetSecs-start_time);
                led3.write(1) ;
                stim_time=GetSecs;
                WaitSecs(0.2);
                led3.write(0);
            ...
            case 4
                fprintf('The onset time for VBP-led4 in block %d is %f seconds\n',i, GetSecs-start_time);
                led4.write(1) ;
                stim_time=GetSecs;
                WaitSecs(0.2);
                led4.write(0);
            ...
            case 5
                fprintf('The onset time for VBP-led5 in block %d is %f seconds\n',i, GetSecs-start_time);
                led5.write(1) ;
                stim_time=GetSecs;
                WaitSecs(0.2);
                led5.write(0);
                ...
                if pressed
                    ...
                    bp_onset=firstPress(bp_key)-start_time;
                    RT=bp_onset-stim_onset;
                    R1_onsets=[R1_onsets;1 1 stim_onset bp_onset RT];
                else
                    R1_onsets=[R1_onsets;1 NaN stim_onset NaN NaN];
                end
                continue
                
            case 6
                fprintf('The onset time for VBP-led6 in block %d is %f seconds\n',i, GetSecs-start_time);
                led6.write(1) ;
                stim_time=GetSecs;
                WaitSecs(0.2);
                led6.write(0);
            ...
            case 7
                fprintf('The onset time for VBP-led7 in block %d is %f seconds\n',i, GetSecs-start_time);
                led7.write(1) ;
                stim_time=GetSecs;
                WaitSecs(0.2);
                led7.write(0);
            ...
            case 8
                fprintf('The onset time for VBP-led8 in block %d is %f seconds\n',i, GetSecs-start_time);
                led8.write(1) ;
                stim_time=GetSecs;
                WaitSecs(0.2);
                led8.write(0);
 ...
 % Somatic button press trials
    ...
    for j= 1:size(array_SBP,2)
        
        trialNumber = trialNumber+1;
        Eyelink('Message', sprintf('TRIAL %u', trialNumber));
        
        switch array_SBP(i,j)
            case 1
                fprintf('The onset time for SBP-stim1 in block %d is %f seconds\n',i, GetSecs-start_time);
                stim1.write(1) ;
                stim_time=GetSecs;
                WaitSecs(0.2);
                stim1.write(0);
            ...
            case 2
                fprintf('The onset time for SBP-stim2 in block %d is  %f seconds\n',i, GetSecs-start_time);
                stim2.write(1) ;
                stim_time=GetSecs;
                WaitSecs(0.2);
                stim2.write(0);
            ...
            case 3
                fprintf('The onset time for SBP-stim3 in block %d is %f seconds\n',i, GetSecs-start_time);
                stim3.write(1) ;
                stim_time=GetSecs;
                WaitSecs(0.2);
                stim3.write(0);
            ...
            case 4
                fprintf('The onset time for SBP-stim4 in block %d is %f seconds\n',i, GetSecs-start_time);
                stim4.write(1);
                stim_time=GetSecs;
                WaitSecs(0.2);
                stim4.write(0);
            ...
            case 5
                fprintf('The onset time for SBP-stim5 in block %d is %f seconds\n',i, GetSecs-start_time);
                stim1.write(1) ;
                stim_time=GetSecs;
                WaitSecs(0.05);
                stim1.write(0);
            ...
            case 6
                fprintf('The onset time for SBP-stim6 in block %d is %f seconds\n',i, GetSecs-start_time);
                stim2.write(1) ;
                stim_time=GetSecs;
                WaitSecs(0.05);
                stim2.write(0);
            ...
            case 7
                fprintf('The onset time for SBP-stim7 in block %d is %f seconds\n',i, GetSecs-start_time);
                stim3.write(1) ;
                stim_time=GetSecs;
                WaitSecs(0.05);
                stim3.write(0);
            ...
            case 8
                fprintf('The onset time for SBP-stim8 in trial %d is %f seconds\n',i, GetSecs-start_time);
                stim4.write(1) ;
                stim_time=GetSecs;
                WaitSecs(0.05);
                stim4.write(0);
...
R1_onsets = array2table(R1_onsets,'VariableNames',{'odd_trial','bp','stim_onset','bp_onset','RT'});

save(fullfile(savePath,'R1_onsets'),'R1_onsets');
