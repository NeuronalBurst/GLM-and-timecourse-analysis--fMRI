...
R3_onsets=[]; %Initialise timing file
cue_onsets=[];
trialNumber=0;
...
for i =1: size (array_VBP,1)
    ...
    led00.write(1);
    cue_onsets=[cue_onsets;GetSecs-start_time];
    WaitSecs(0.3);
    led00.write(0);
    WaitSecs(2);
        ...
        switch array_VBP(i,j)
            ...
            case 1
                ...
                if pressed
                    ...
                    R3_onsets=[R3_onsets;NaN 1 stim_onset bp_onset RT];
                else
                    R3_onsets=[R3_onsets;NaN NaN stim_onset NaN NaN];
                end
                continue
            ...
            case 5
                ...
                if pressed
                    ...
                    bp_onset=firstPress(bp_key)-start_time;
                    RT=bp_onset-stim_onset;
                    R3_onsets=[R3_onsets;1 1 stim_onset bp_onset RT];
                else
                    R3_onsets=[R3_onsets;1 NaN stim_onset NaN NaN];
                end
                continue
...
R3_onsets = array2table(R3_onsets,'VariableNames',{'odd_trial','bp','stim_onset','bp_onset','RT'});

save(fullfile(savePath,'R3_onsets'),'R3_onsets','cue_onsets');
