...
R4_onsets=[]; %Initialise timing file
cue_onsets=[];
trialNumber=0;
        ...
        switch array_SBP(i,j)
            case 1
                ...
                if pressed
                    ...
                    R4_onsets=[R4_onsets;NaN 1 stim_onset bp_onset RT];
                else
                    R4_onsets=[R4_onsets;1 NaN stim_onset NaN NaN];
                end
                continue
            ...
            case 5
                ...
                if pressed
                    ...
                    bp_onset=firstPress(bp_key)-start_time;
                    RT=bp_onset-stim_onset;
                    R4_onsets=[R4_onsets;1 1 stim_onset bp_onset RT];
                else
                    R4_onsets=[R4_onsets;1 NaN stim_onset NaN NaN];
                end
                continue
...
R4_onsets = array2table(R4_onsets,'VariableNames',{'odd_trial','bp','stim_onset','bp_onset','RT'});

save(fullfile(savePath,'R4_onsets'),'R4_onsets','cue_onsets');
